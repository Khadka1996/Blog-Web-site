...
const OurTools = () => {
  const tools = [
    ...
    {
      name: "Split PDF",
      description: "Separate one PDF into multiple smaller files quickly and easily and in efficient way.",
  ...
  return (
    <section className="py-4 bg-gradient-to-b from-[#f8fafc] to-[#eef2f6]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Powerful Tools at Your Fingertips</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, index) => (
            ...
            >
              ...
              {/* Tool content */}
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#25609a] mb-2">{tool.name}</h3>
